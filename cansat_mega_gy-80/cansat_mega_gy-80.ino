...
void loop() {
  ...
  if (GPS_ferdig)
{
RF_port.print(millis());RF_port.print(sh);
dataFile.print(millis());dataFile.print(sh);
...
{
 dataFile.print(millis()); dataFile.print(shh);
    RF_port.print(millis()); RF_port.print(shh);
